...
public struct CoreDataEntityDescription {
    ...
    public static func entity(name: String, managedObjectClass: NSManagedObject.Type = NSManagedObject.self, parentEntity: String? = nil, uniqueConstraints: [[String]] = [], attributes: [CoreDataAttributeDescription] = [], fetchedProperties: [CoreDataFetchedPropertyDescription] = [], relationships: [CoreDataRelationshipDescription] = [], configuration: String = "Default") -> CoreDataEntityDescription {
